...
| Path | Meaning |
|------|---------|
| `runs/<run_id>/pipeline_run_manifest_v1.json` | Full run summary: phases, stage pass/fail, Justice deliverable presence |
...
4. **deliverables** — Justice §7 outputs + gated variants
