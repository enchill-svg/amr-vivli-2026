...
export const Route = createFileRoute("/alerts")({
  ...
  head: () => ({ meta: [
    ...
    { name: "description", content: "WFP HungerMap-style live AMR risk map with country trends, early warnings, and intervention priorities." },
  ] }),
});
...
function RiskMapPage() {
  return (
    <CommandPage
      ...
      kpis={[
        { label: "Live layers", value: "4", color: "var(--accent)", sub: "Risk · warning · burden · funding" },
        { label: "Signal types", value: "2", color: "var(--status-info)", sub: "Bacterial + fungal" },
    ...
    >
      <GlassCard title="AMR HungerMap-style operating picture" subtitle="Click a country bubble to inspect the dominant organism–drug signal, confidence, predicted life-expectancy gain, and policy recommendation.">
