    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-white/50 mt-1">
          Real-time posture across users, surveillance, and security.
        </p>
      </header>
      ...
      <section className="grid lg:grid-cols-2 gap-4">
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/admin/users" className="text-xs text-cyan-300 hover:underline">
              Review pending →
            </Link>
          </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link to="/admin/audit" className="text-xs text-cyan-300 hover:underline">
              Full log →
            </Link>
          </div>
...
function Metric({
  ...
  return (
    <div
      className={`rounded-xl border ${accent ? "border-amber-400/30 bg-amber-500/5" : "border-white/10 bg-white/[0.03]"} backdrop-blur-xl p-4`}
    >
